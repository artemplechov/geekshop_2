...
from vscode_datascience_helpers.daemon.daemon_output import CustomWriter, IORedirector, get_io_buffers, redirect_output
...
def error_decorator(func):
    ...
    def _decorator(self, *args, **kwargs):
        try:
            ...
            log.info("Failed executing an rpc method. Error: %s", traceback.format_exc())
